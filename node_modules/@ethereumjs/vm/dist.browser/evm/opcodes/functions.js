...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState) {
            ...
            var loaded = new ethereumjs_util_1.BN(runState.code.slice(runState.programCounter, runState.programCounter + numToPush));
    ...
    [
        ...
        function (runState) {
            ...
            var keyBuf = key.toArrayLike(Buffer, 'be', 32);
            var value = runState.eei.transientStorageLoad(keyBuf);
            var valueBN = value.length ? new ethereumjs_util_1.BN(value) : new ethereumjs_util_1.BN(0);
            runState.stack.push(valueBN);
        },
    ],
    // 0xb4: TSTORE
    [
        ...
        function (runState) {
            ...
            var _a = __read(runState.stack.popN(2), 2), key = _a[0], val = _a[1];
            var keyBuf = key.toArrayLike(Buffer, 'be', 32);
