...
function printWarningAboutNodeJsVersionIfNecessary(packageJson) {
...
async function main() {
    ...
    try {
        ...
        const env = new runtime_environment_1.Environment(resolvedConfig, hardhatArguments, taskDefinitions, envExtenders, ctx.experimentalHardhatNetworkMessageTraceHooks, userConfig);
